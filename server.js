 ...
 * information and we know that because the port won't be set */
 ...
 /* Setup a static webserver that will deliver files from the filesystem */
...
io.sockets.on('connection', function (socket){
	...
	socket.on('disconnect', function(socket){
		log('A website has disconnected from the server');
	});
  ...
  /*join room command
  	...
  	*/
  	socket.on('join_room', function(payload){
  		log('the server recieve a command', 'join_room', payload);
